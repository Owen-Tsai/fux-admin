<template>
  ...
  <TFormItem label="全路径模式" class="boolean-setter">
    <TSwitch v-model:value="props.showAllLevels" :default-value="true" />
  </TFormItem>
...
const props = defineModel<WidgetMap['cascader']['props']>('props', { required: true })
