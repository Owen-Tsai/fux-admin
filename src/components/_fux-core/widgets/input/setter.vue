<template>
  ...
  <TFormItem label="最大长度" name="maxlength">
    <TInputNumber v-model:value="props.maxlength" theme="column" />
  </TFormItem>
...
const props = defineModel<WidgetMap['input']['props']>('props', { required: true })
</script>
