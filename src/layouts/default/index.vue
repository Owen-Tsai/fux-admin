<template>
  <TLayout class="h-full max-h-screen flex flex-col">
    <Header class="flex-none border-b border-b-solid border-[var(--td-border-level-1-color)]" />
    <TLayout class="flex min-h-0">
      <TAside
        class="flex-none w-full border-r border-r-solid border-[var(--td-border-level-1-color)] overflow-y-auto"
        width="auto"
      >
        <Menu />
      </TAside>
